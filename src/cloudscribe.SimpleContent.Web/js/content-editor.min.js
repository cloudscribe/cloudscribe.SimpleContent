!function (e) {
    ...
    editContent = function () { l.attr("contentEditable", !0), c.attr("contentEditable", !0), c.css({ minHeight: "100px" }), c.parent().css("display", "block"), s.wysiwyg({ hotKeys: {}, activeToolbarClass: "active" }), s.css({ minHeight: "400px" }), "new" == i && (l.attr("placeholder", "type your title here"), c.attr("placeholder", "type your meta description here"), s.attr("placeholder", "type your main content here")), d.datetimepicker({ debug: !1, widgetPositioning: { horizontal: "left", vertical: "bottom" }, keepOpen: !0, allowInputToggle: !0 }), w.attr("disabled", !0), C.attr("disabled", !0), y.removeAttr("disabled"), x.removeAttr("disabled"), "new" == i ? e("#liDelete").hide() : e("#liDelete").show(), e("#liSave").show(), e("#liCancel").show(), e("#liPublished").show(), "Page" == r ? e("#liPageOrder").show() : e("#liPageOrder").hide(), e("#liNewItem").hide(), e("#liEdit").hide(), n && showCategoriesForEditing(), toggleSourceView(), e("#tools").fadeIn().css("display", "inline-block") }, cancelEdit = function () { i.length > 0 ? confirm("Do you want to leave this page?") && history.back() : window.location = H }, toggleSourceView = function () {
    ...
    }, deleteContent = function () { confirm("Are you sure you want to delete this " + r + "?") && e.post(D, { id: o, __RequestVerificationToken: document.querySelector("input[name=__RequestVerificationToken]").getAttribute("value") }).success(function () { location.href = P }).fail(function () { showMessage(!1, "Something went wrong. Please try again") }) }, showMessage = function (e, t) {
        ...
        e ? (v.hide(), T.show(), T.animate({ top: I, right: "0px" }, 500, "swing"), clearToolbarCookie()) : (v.show(), T.hide(), toolBarCookieExists() || setToolbarCookie())
    }, setInitialToggleState = function () { toolBarCookieExists() ? v.show() : (v.hide(), T.animate({ top: I, right: "0px" }, 500, "swing")) }, addToolBarPadding = function () { R = v.height() }, removeToolbarPadding = function () { }, v = e("#editor-toolbar"), r = e("#editor-toolbar").data("content-type"), "Page" == r ? (o = e("article").first().attr("data-id"), l = e("#article-title"), h = e("#txtPageOrder"), p = e("#txtParentPage"), m = e("#txtViewRoles"), f = e("#chkShowHeading")) : (o = e("[itemprop~='blogPost']").attr("data-id"), l = e("[itemprop~='blogPost'] [itemprop~='name']")), c = e("[itemprop~='description']"), s = e("[itemprop~='articleBody']"), g = e("#editor-toolbar .alert"), u = e("#editor-toolbar #txtImage"), d = e("[itemprop~='datePublished']"), w = e("#btnNew"), C = e("#btnEdit"), k = e("#btnDelete").bind("click", deleteContent), y = e("#btnSave").bind("click", saveContent), x = e("#btnCancel").bind("click", cancelEdit), T = e("#editor-outer-toggle"), b = e("#published"), P = e("#editor-toolbar").data("index-path"), E = e("#editor-toolbar").data("category-path"), S = e("#editor-toolbar").data("save-path"), D = e("#editor-toolbar").data("delete-path"), H = e("#editor-toolbar").data("cancel-edit-path"), a = e("#editor-toolbar").data("current-slug"), n = "True" == e("#editor-toolbar").data("supports-categories"), i = e("#editor-toolbar").data("edit-mode")
    var I = e(".navbar-fixed-top").first().height(), R = v.height()
    v.height()
    "Post" == r && 0 == a.length && e("#liEdit").hide(), e("#btnHide").click(function (e) { e.preventDefault(), toggleToolbar() }), T.click(function (e) { e.preventDefault(), toggleToolbar() }), setInitialToggleState(), 0 == a.length, e(document).keyup(function (e) { document.activeElement.isContentEditable || (46 === e.keyCode ? deleteContent() : 27 === e.keyCode && cancelEdit()) }), e(".uploadimage").click(function (t) { t.preventDefault(), e("#txtImage").click() }), "new" == i || "edit" == i ? editContent() : "Page" == r && a && C.removeAttr("disabled"), e(".dropdown-menu > input").click(function (e) { e.stopPropagation() })
}(jQuery)
