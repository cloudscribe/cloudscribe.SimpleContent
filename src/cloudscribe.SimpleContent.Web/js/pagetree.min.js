...
var a=!1
return $.ajax({type:"POST",url:t.urls.moveUrl,async:!1,headers:{"X-CSRFToken":this.xsrfToken},dataType:"json",data:n,success:function(e,t,i){e.success?a=!0:alert(e.message)},complete:function(e,t){},error:function(e,t,i){alert(i)}}),a},init:function(){this.ui.sortButton.click(function(e){e.preventDefault()
...
var e={}
e.pageId=i.id,$.ajax({type:"POST",url:t.urls.sortUrl,headers:{"X-CSRFToken":t.xsrfToken},async:!1,processData:!0,dataType:"json",data:e,success:function(e,o,r){e.success?t.ui.treeDiv.tree("loadDataFromUrl",i):alert(e.message)},complete:function(e,t){},error:function(e,t,i){alert(i)}})}
...
var e={}
e.id=o.id,$.ajax({type:"POST",url:t.urls.deleteUrl,headers:{"X-CSRFToken":t.xsrfToken},async:!1,dataType:"json",data:e,success:function(e,i,r){e.success?(t.ui.treeDiv.tree("removeNode",o),t.ui.cmdBarDiv.hide()):alert(e.message)},complete:function(e,t){},error:function(e,t,i){alert(t)}})}
