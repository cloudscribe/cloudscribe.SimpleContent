...
return e.Sort.subscribe(t.handleSortItemChanged),e})),t.addItem=function(e,r,n,i,l,o,s){var a=new ListItem(e,r,n,i,l,o,s)
a.Sort.subscribe(t.handleSortItemChanged),t.Items.push(a),window.thisPage=window.thisPage||{},window.thisPage.hasUnsavedChanges=!0},t.newItemTitle=ko.observable(null).extend({required:"Title is required"}),t.newItemDescription=ko.observable(null),t.newItemFullSizeUrl=ko.observable(null),t.newItemResizedUrl=ko.observable(null),t.newItemThumbnailUrl=ko.observable(null),t.newItemLinkUrl=ko.observable(null).extend({isValidUrl:null}),t.newItemSort=function(){if(0===t.Items().length)return 1
var e=Math.max.apply(Math,t.Items().map(function(e){return e.Sort()}))
return e+2},t.addNewItem=function(){t.addItem(t.newItemTitle(),t.newItemDescription(),t.newItemFullSizeUrl(),t.newItemResizedUrl(),t.newItemThumbnailUrl(),t.newItemLinkUrl(),t.newItemSort()),t.newItemTitle(null),t.newItemDescription(null),t.newItemFullSizeUrl(null),t.newItemResizedUrl(null),t.newItemThumbnailUrl(null),t.newItemLinkUrl(null),window.cloudscribeDropAndCrop.clearAllItems()},t.removeItem=function(e){t.Items.remove(e),window.thisPage=window.thisPage||{},window.thisPage.hasUnsavedChanges=!0},t.getCssClass=function(e){return 0===e?"carousel-item active":"carousel-item"},t.dropZoneSuccess=function(e,r){t.newItemFullSizeUrl(r[0].originalUrl),t.newItemResizedUrl(r[0].resizedUrl),t.newItemThumbnailUrl(r[0].thumbUrl)},window.DropZoneSuccessHandler=t.dropZoneSuccess,t.handleCropSave=function(e){t.newItemResizedUrl(e)},window.HandleCropResult=t.handleCropSave,t.serverFileSelected=function(e){t.newItemResizedUrl(e)},window.ServerFileSelected=t.serverFileSelected,t.filteredItems=ko.computed(function(){return ko.utils.arrayFilter(t.Items(),function(e){return 0==e.LinkUrl.hasError()&&0==e.Title.hasError()})}),t.currentListState=ko.computed(function(){return encodeURIComponent(ko.toJSON(t.filteredItems()))}),t.sortItems=function(){t.Items.sort(function(e,t){return e.Sort()<t.Sort()?-1:e.Sort()>t.Sort()?1:0})},t._testEle=null,t.isValidNewItemLink=ko.computed(function(){return t.newItemTitle.hasError()?!1:t.newItemLinkUrl.hasError()?!1:!0})}function decodeEncodedJson(e){if(null===e)return e
