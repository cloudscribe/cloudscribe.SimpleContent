...
var r=function(){$("#mdlConfirm").modal("hide")
var e={}
e.pageId=i.id,$.ajax({type:"POST",url:t.urls.sortUrl,headers:{"X-XSRF-TOKEN":t.xsrfToken},async:!1,processData:!0,dataType:"json",data:e,success:function(e,o,r){e.success?t.ui.treeDiv.tree("loadDataFromUrl",i):alert(e.message)},complete:function(e,t){},error:function(e,t,i){alert(i)}})}
$("#btnConfirm").off("click").on("click",r)}),t.ui.deleteButton.click(function(e){e.preventDefault()
...
var r=function(){$("#mdlDelete").modal("hide")
var e={}
e.id=o.id,$.ajax({type:"POST",url:t.urls.deleteUrl,headers:{"X-XSRF-TOKEN":t.xsrfToken},async:!1,dataType:"json",data:e,success:function(e,i,r){e.success?(t.ui.treeDiv.tree("removeNode",o),t.ui.cmdBarDiv.hide()):alert(e.message)},complete:function(e,t){},error:function(e,t,i){alert(t)}})}
$("#btnConfirmDelete").off("click").on("click",r)}),t.ui.treeDiv.tree({dataUrl:t.urls.treeDataUrl,dragAndDrop:!0,onLoadFailed:function(e){alert(e)}}),t.ui.treeDiv.bind("tree.click",function(e){e.node}),t.ui.treeDiv.bind("tree.dblclick",function(t){console.log(e.node)}),t.ui.treeDiv.bind("tree.select",function(e){if(e.node)t.showCommands(e.node)
